...
**Next:** Gate 2B (SME Validation)

---

## GATE 2B: SME VALIDATION

**Purpose:** Validate scope through subject matter expert lens before building.

**Agent becomes SME and challenges the scope:**
...
I'm now reviewing your scope as a Subject Matter Expert.

Based on SCOPE.md, I have concerns/questions:

1. [SME question about market/feasibility]
2. [SME question about technical approach]
3. [SME question about user assumptions]

For each, answer or type "OVERRIDE" to proceed anyway:
═══════════════════════════════════════════════════════════════════
```

**Wait for response to each.**

**SME Challenge Areas:**

```
MARKET FIT:
- Is the persona correctly identified?
...
- What makes them switch from current solution?
```

**After SME validation:**
...
Type PROCEED to continue to architecture, or REVISIT to update scope.
═══════════════════════════════════════════════════════════════════
```

**Output:** Update `project-context/SCOPE_LOCK.md` with SME notes  
**Next:** Gate 3
...
- Gate: score >= threshold = proceed to Gate 5B
- Below threshold = `GAP_REPORT.md`, loop back

---

## GATE 5B: SME SHIP VALIDATION

**Purpose:** Final expert review before deployment.

**Agent becomes SME and validates the shipped feature:**
...
I'm reviewing the shipped feature as a Subject Matter Expert.

OUTCOME CHECK:
1. Does this deliver the outcome in SCOPE.md?
2. Would the target persona actually use this?
3. What's missing that would block adoption?

QUALITY CHECK:
4. Are there obvious bugs or UX issues?
5. Does it handle edge cases?
6. Is it production-ready or prototype-grade?

RISK CHECK:
7. What could go wrong in production?
8. What's the blast radius if it fails?
9. Is rollback possible?

For each concern, answer or type "ACCEPT-RISK":
═══════════════════════════════════════════════════════════════════
```

**Wait for response to each.**

**After SME ship validation:**

```
═══════════════════════════════════════════════════════════════════
SME SHIP VALIDATION COMPLETE
═══════════════════════════════════════════════════════════════════

Outcome verified: [YES / PARTIAL / NO]
Quality grade: [PRODUCTION / BETA / PROTOTYPE]
Risk level: [LOW / MEDIUM / HIGH]
Concerns addressed: [count]
Risks accepted: [count]

Type DEPLOY to ship, or ITERATE to fix issues first.
═══════════════════════════════════════════════════════════════════
```

**Output:** Update `reports/SHIP_VALIDATION.md`  
**DEPLOY:** Proceed to deployment  
**ITERATE:** Loop back to Gate 4 with specific fixes
